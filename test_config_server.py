...
class TestConfigServer(unittest.TestCase):
    ...
    def test_licensingservice_aws_dev(self):
         ...
         self.assertEquals("https://github.com/klimtever/config-repo/licensingservice/licensingservice-aws-dev.yml",
    ...
    def test_licensingservice_default(self):
         ...
         results = json.loads(content.decode("utf-8"))
         self.assertEqual(resp.status, 200)
         self.assertEquals("https://github.com/klimtever/config-repo/licensingservice/licensingservice.yml",
                           results["propertySources"][0]["name"])
    ...
    def test_organizationservice_default(self):
         ...
         results = json.loads(content.decode("utf-8"))
         self.assertEqual(resp.status, 200)
         self.assertEquals("https://github.com/klimtever/config-repo/organizationservice/organizationservice.yml",
                           results["propertySources"][0]["name"])
    ...
    def test_organizationservice_aws_dev(self):
         ...
         results = json.loads(content.decode("utf-8"))
         self.assertEqual(resp.status, 200)
         self.assertEquals("https://github.com/klimtever/config-repo/organizationservice/organizationservice-aws-dev.yml",
                           results["propertySources"][0]["name"])
